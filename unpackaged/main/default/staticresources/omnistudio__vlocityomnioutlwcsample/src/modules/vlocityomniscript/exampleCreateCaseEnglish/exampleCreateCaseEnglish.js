...
import { OMNIDEF } from './exampleCreateCaseEnglish_def.js';
import tmpl from './exampleCreateCaseEnglish.html';
import tmpl_nds from './exampleCreateCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class exampleCreateCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
