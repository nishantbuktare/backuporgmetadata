...
import { OMNIDEF } from './exampleCloseCaseEnglish_def.js';
import tmpl from './exampleCloseCaseEnglish.html';
import tmpl_nds from './exampleCloseCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class exampleCloseCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
